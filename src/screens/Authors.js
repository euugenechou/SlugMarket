      ...
      <ScrollView style={field.contentContainer}>
        <Hyperlink linkDefault={true}>
          ...
          <Text style={field.baseText}>
            ...
            carefully before using the slugmarket.com website (the "Service")
            operated by Slug Market ("us", "we", or "our"). {"\n"}
          </Text>
          <Text style={field.baseText}>
          ...
          <Text style={field.baseText}>
            ...
            access the Service. This Terms of Service agreement for Slug Market
            is
            <Text style={field.linkText}>
              {" "}
          ...
          <Text style={field.baseText}>
            ...
            that are not owned or controlled by Slug Market. {"\n"}
          </Text>
          <Text style={field.baseText}>
            Slug Market has no control over, and assumes no responsibility for,
            the content, privacy policies, or practices of any third party web
            sites or services. You further acknowledge and agree that Slug
            Market shall not be responsible or liable, directly or indirectly,
